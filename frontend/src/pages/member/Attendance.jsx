...
//   const { streak, badge, updateStreak, getStreakEmoji, fetchStreak } = useStreak(user?.id)
...
//             <p className="text-slate-400 text-xs">🏆 Best: {streak.longest} days</p>
...
//           <p className="text-green-400 text-2xl font-black mt-1">{presentCount}</p>
...
//         </div>
//         <div className="flex-1 bg-[#1a1a2e] border border-white/7 rounded-xl p-3">
//           <p className="text-slate-400 text-[9px] font-bold uppercase tracking-wider">Rate</p>
...
//       {/* Calendar */}
//       <p className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-3">Calendar</p>
//       <div className="bg-[#1a1a2e] border border-white/7 rounded-xl p-4 mb-4">
//         <div className="grid grid-cols-7 gap-1 mb-2">
//           {['M','T','W','T','F','S','S'].map((d, i) => (
//             <div key={i} className="text-center text-slate-500 text-xs font-bold">{d}</div>
//           ))}
//         </div>
