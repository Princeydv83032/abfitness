    ...
    <div className="min-h-screen bg-[#0d0d14] px-4 pt-12 pb-10">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-3">
          <p className="text-green-400 text-xs font-bold">📅 Membership Valid Until</p>
        ...
        <button
          ...
          disabled={!form.name || form.phone.length !== 10 || loading || pricesLoading}
          className="w-full bg-purple-600 text-white font-bold py-3 rounded-xl text-sm disabled:opacity-50"
        >
          {loading ? '⏳ Adding...' : `✅ Add Member — ₹${(planPrices[form.plan] || 0).toLocaleString('en-IN')}`}
        </button>
